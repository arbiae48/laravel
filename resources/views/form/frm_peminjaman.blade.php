        ...
        <div class="modal-body">
            <table id="data" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $rbuku->kd_koleksi }}</td>
                        <td>{{ $rbuku->no_induk_buku }}</td>                    
                        <td>{{ $rbuku->judul }}</td>
                        <td>
                            <button class="btn btn-primary btn-xs btn-flat" onclick="add_buku('{{ $rbuku->no_induk_buku }}','{{ $rbuku->judul }}')" data-dismiss="modal">PILIH</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
