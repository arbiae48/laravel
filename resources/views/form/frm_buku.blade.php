        ...
        <div class="fFoto col-md-3">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    @else
                        <img id="avatar" src="{{ asset('img/no-img.png') }}" style="width:100%;border: 2px solid #ccc;">
                    @endif
                    <input id="file" type="file" name="foto" style="opacity: 0; position: absolute; top: 0; left: 0; width: 100%; height: 100%;">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="tempat" placeholder="tempat_terbit" value="{{ $buku['tempat_terbit'] }}">                 
                            </div>
                        <div class="col-sm-5">
                             <input type="text" class="form-control" id="tahun" placeholder="tahun_terbit" value="{{ $buku['tahun_terbit'] }}"> </div>
                    </div>
                    <div class="form-group">
